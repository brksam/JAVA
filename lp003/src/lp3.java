...
public class lp3 {
    ...
    private static double totalgasto(int totalcigarro, double maco){
        return (totalcigarro / 20) * maco;
    }
    private static double qtdMacos(int totalcigarro){
        return totalcigarro / 20;
    }
    private static double qtTempo(int totalcigarro){
